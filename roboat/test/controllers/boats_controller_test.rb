...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { battery_status: @boat.battery_status, compass: @boat.compass, speed: @boat.speed } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { battery_status: @boat.battery_status, compass: @boat.compass, speed: @boat.speed } }
